  ...
  features: [
    ...
    },
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [
          '@@DE@OCMIKMCcGa@EAGGCEAISBADAFA@AC@CAAO@CBA@ACCACBABAFBFDBIDBFCJCBYBAB@BXD@FRDTCNCXAJFFFFJHHZBHALGJ@PBNL',
        ],
    ...
    },
    {
      ...
      geometry: {
        ...
        coordinates: [
          [
            '@@F@@E@CNEAM@CDCHADBCHDDFABEH@AI@CFABBBDFBBA@CD@BFCHDBDAACBEFDDADACAFCB@JJADCRFTBLF@BBGDADEDED@DHLFTDBFCHFFA@DENED@BEAAEIDAFBFAHDBACFC@DFHN@AFH@FAH@@AAEHED@BBCDE@@DD@VGDBFFD@@IFCBBBLB@BCDALCLED@CFJKCIODI@MICMCc@KDIDEjqHEN]BIEGA@OD[PKBQAMAeO]QKMEMGOGGGEUGWKUC@LEJAPD@J@LREDCZMHEHBBD@@DEJCVBFHBBBKNBRFL@FBDJCHB',
            '@@EDHBAC',
            '@@@B@A',
            '@@@@@B',
          ],
    ...
    },
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [
          '@@ACMMKGKUAECCOW@EM_EEMW@EACIKMSGSGCKB[CEBGCC@BFADCBUBACBC@CEEMG@ADIHCECKCGGIEKB@BFFCBI@EJGEBEA@GDGDGHC@OCICCDC@E@CAGBEBBDADCBG@IEC@CCAGCAQRC@@AIEENBDGFE@CJSFC@ACG@ALAFULKHAF@F@hFLFFHD\\@jHNDJLDN@LAJIDELAXBLHPHJ^PTBF@NEHIBQJQNIDAJBLHHBBAHIViDCLCH@PDHFHJPJpNNFFFNbBDHD^BpKFCFUFC',
        ],
