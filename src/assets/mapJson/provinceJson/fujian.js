  ...
  features: [
    {
      ...
      geometry: {
        ...
        coordinates: [
          [
            '@@K@KLDBLBBIHCAA',
            '@@CBABCD@FJFCFBDHFFBB@FM@CCE@EACIA',
            '@@ACCBBDD@',
            '@@@CC@@DD@',
            '@@B@AA',
            '@@@@',
            '@@MCKEO@ICCCAEAKBKAAIAC@AVFPCRBBFBNHNBVXJ@DADCHAB@@GBCL@B@BCCIEEBC@CHCACG@ABINCBAA',
            '@@A@',
            '@@A@CDC@WH@FLXCB@DFDATBFH@HELA@CCACI@AFAD@BA@AH@DED@FDBHHHJDT@JC@AEOECGKC@EDOQIACBG@CC@CEA',
            '@@B@BCE@@D',
            '@@J@BA@AAAI@ABBD',
            '@@B@@AAAA@BD',
            '@@B@@AA@@B',
            ...
            '@@B@AAA@BB',
            '@@DA@CC@@D',
            '@@MDFFAFBH@BCFCDBN@BHFDJJHFBDCDMCCE@AA@EHOD@HDDABC@ECCGDCEGAGACC@I',
            '@@B@@AA@@B',
            '@@B@@AA@@B',
            '@@B@A@',
            '@@B@A@',
            ...
            '@@BA@CC@ABCCC@@BDDFB',
            '@@BKCEEAEF@HBDJD',
            '@@E@AFCBC@CCABACA@AACFB@@BADQAALDDAB@JBFADLADGAC@@PBHF@@DCAAAECEJCDDAFBDCDBLDBBA@AAADAAADA@ADBDACGDACADCAADEGKE@@A',
            '@@ABBBAFEBQBEDQBABCJOLEHD^NF\\BLGFMH@FKD@LBPENB@A@CM@CAAE@CBA@CE@A@@ABA@EDAAKE@ME',
            '@@@HCBEAEJAH@BDDL@DCFDNBB@@CFBDEEEGGG@A@BCEECA',
            '@@ABFLAB@DJDFNDDJ@BCDAFHBBFC@CGEBCKEA@BEIC@CCBADIIA@ACA@',
            '@@FD@A@CAC@AEADFAB',
            '@@C@@BDDD@@FBB@DAB@B@BB@BA@AF@@CFEIEIA',
            '@@BDHBB@CGBGEADAACCCEACCC@@DE@@DHDHL',
            '@@@AA@BB',
            '@@FFB@@CACE@',
            '@@ABD@@BB@HACCABE@',
            '@@BBJ@DBDAAEA@CAABC@ACAF',
            '@@ABBBF@AAC@',
            '@@@DFJDBFFHDB@@ECCEGEACEA@',
            '@@DHDBD@FADCCEFAFBB@HKBECCEDC@A@CF@@AGEECCCGABABABCAEBAABCAAA@GH@DDDAFF@BBADGBECABARCACIAACB@HAFLFAFBBL@BABCDEAM@AF@FBD@BB',
            '@@CBD@BAA@',
            '@@B@@AA@@B',
            '@@DBBACAAB',
            '@@DFDAACA@@EC@@D',
            ...
            '@@FDH@GEC@',
            '@@C@ADHBBF@@DAFBCEGE',
            '@@BCAEBA@IECABBJEHID@FMFBBBBBFD@FFD@D@@HBBF@RADCBE@CGCEBAAGG@C',
            '@@B@@BD@@CAAAAAF',
            '@@BDAE@B',
            '@@CFDDD@FAN@@GCC@ECACD',
            '@@BB@AA@',
            ...
            '@@@BB@AA',
            '@@EDBDB@FA@EA@',
            '@@CF@DAD@DFBBA@CBBHBBABAD@ACAABEAAEAC@',
            '@@@@@A@B',
            '@@BBBA@AC@',
            '@@DB@CC@',
            '@@DDB@@A@EEB',
            ...
            '@@B@AA',
            '@@JHB@@CKC',
            '@@DDHFBBDCFDD@JHDA@@KKCAACEBEGGCABBDCB',
            '@@DFNJHBJOJEBACGIACCK@CAEBCCC@AD@L',
            '@@ADBBHAAABCAAED',
            '@@@BBA@@',
            '@@HBBCAE@@GH',
            '@@HHB@CECCA@',
            '@@P@@A@CECM@@DBF',
            '@@IKGACD@FNLHJFBB@@ECC',
            '@@A@CDG@CBC@EFIDBBAD@BDDFA@FDFD@BICKDAD@JNDBBJAB@BPH@BJJF@FDAHHDF@DANH@GCA@CBCCMIKBCE@CA@GECE@IEE@@ABACGIE',
            '@@BA@AA@AD',
            '@@BCAAAAC@DH',
            '@@DB@CBAC@AD',
            '@@@@@@',
            '@@FAB@BCAAE@CDBD',
            '@@JNPJF@DABAAI@ADAVHZFFBHJJDF@DA@EEI@EFG@C@A@KAEECIAGBIJC@IGQA@BC@GEEBE@GCABADMJC@@BAH',
            '@@DDBAACC@@B',
            '@@BAAB',
            '@@DBBA@CC@AD',
            '@@JFBCDA@AACGAED@B',
            ...
            '@@@DBAAA',
            '@@@AAA@BABB@',
            '@@DIF@ACCBCAC@@DCBALA@ABBBF@DC',
            '@@BDD@CI@@AD',
            '@@@@@@',
            '@@@BB@@@AA',
            '@@BHBBFA@AAABCCCBCAAA@ABC@BH',
            '@@CDD@BAAA',
            '@@ADBDB@FMC@CD',
            '@@ADBBDCAA',
            '@@@BBAAA',
            ...
            '@@@EAACFAAAFBBBCF@',
            '@@EDADD@DABBD@@ECA',
            '@@@BBFCBC@A@ERBBJ@FBF@EFE@@DDBN@HED@FBCFFBBDD@JC@CEEBCAANCBCB@@CKEEEOAGCADE@IE',
            '@@@BBBF@ACC@',
            '@@@BBBDCCCAB',
            '@@ABBBDCCA@B',
            '@@GDDFHABAACAA',
            ...
            '@@AB@BB@@C',
            '@@B@@CE@AD@@D@',
            '@@CDM@@BDBAFFBBDBB@FFDRFLDAK@ICEHKACGACBABC@IA',
            '@@DBDA@CEAAD',
            '@@DDAEA@@B',
            '@@CCA@FLDCBCC@',
            '@@BBBCCAAB',
            '@@BBBAAAA@',
            '@@@BDJJFBACEBCDAHCBAEACDG@',
            '@@@DDA@AC@',
            '@@AB@BFCC@',
            '@@@BB@AA',
            '@@@AAB@@B@',
    ...
    },
    {
      ...
      geometry: {
        ...
        coordinates: [
          [
            '@@ABG@DFAFHDDH@B@BF@@CHBBCAAHCAGDC@CE@GBCAE@AA',
            '@@@FAAGDBNDFD@@EBA@CBCB@DBDACECAA@AC',
            '@@F@@AAACB',
            '@@EBMLCF@FHBLEDEDG@CAA',
            '@@B@A@',
            '@@BBB@AC@@',
            '@@BDD@CCA@',
            '@@BBB@ACA@',
      ...
      geometry: {
        ...
        coordinates: [
          [
            ...
            '@@B@@AAB',
            '@@F@B@GA@B',
            '@@MHIBEF@BJFBDBFCJ@FFFN@DZDJHDR@BBBDFBDBDAPKVIAKCG@MEKAAI@ABADE@IGBECGICGDC@EAKM',
            '@@B@@CE@ABBB',
            '@@H@AEBGHAFBD@AEICGFE@BFEHBD',
            '@@B@DCJ@CCGACDC@@DDB',
            '@@ACA@@BBB',
            '@@BA@AC@BD',
            '@@GAADLJH@@EDCAAIB',
            ...
            '@@HC@AC@CD',
            '@@@BBBBC@ECD',
            '@@AACAAEEAAIC@ALFDBADJBFFBD@@AAABC',
            '@@@AA@BB',
            '@@@A@ACB@BD@',
            '@@ABBBF@@ABDD@AGEB@A',
            '@@B@BGAECCADBH',
            ...
            '@@B@BAC@',
            '@@EDBBFA@AAA',
            '@@@FAB@DCDBDBBBAF@BA@EBCHA@AGGA@EB',
            '@@ABB@B@AA',
            '@@A@@@',
            '@@ACCAEB@BHBDDB@@A',
            '@@BAAAE@ABFB',
            ...
            '@@FDD@@AGA',
            '@@BBD@BAE@',
            '@@BNCHBDD@BEFCB@@DHBH@DCDBBACCFGBKFEDAZAFA@AAI@EBCFABCBOHIDAHDHA@CIMAG@MFMDEH@FC@E@GCEEAC@@BABAACEEABEBAFIGGC@CBCAAABG@AEEQGC@MGUACFBDHDJ@BDADIHSBKDKHKFY@gCWKOICE[sGGGAG@MBWPOBAHGF@FWNAD@DDDN@DB@DEHBDHBd@@BC`I\\CHCDKFABAJDLNJTFBHFBLEDCl]NEdIJCNBPLDJAJMNBBJAF@BFLFBFAFEB@BBB@FCN@FRBNF',
            '@@D@A@A@',
            '@@@DD@BACA',
            '@@AB@BFBBEAAAB',
            '@@BBBAA@A@',
